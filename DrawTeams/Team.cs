    ...
    public class Team
    {
        ...
        public Team()
        {
            _team = new List<Player>()
            {
                ...
                new Player("Kamil Pakalski",6,false),
                new Player("Karol Skupski",11,true),
                new Player("Przemek Stolle",9,false),
                new Player("Damian Kisielewski",12,true),
                ...
                new Player("Krzysiek Taranowski",9,true),
               ...
               new Player("Kuba Krzemiński",9,true),
                new Player("Hubert Koczergo",12,true),
               new Player("Marcin Urbaniak",10,false),
               new Player("Dorian (od Mateusza)",8,true),
                  new Player("Tomek(od Mateusza)",7,false),
                  new Player("Maciej (od Jarka)",8,false),
                  new Player("Dawid (od Jarka)",7,true),
                  new Player("Mateusz (od Łukasz)",8,false),
                  new Player("Paweł Harhaj",7,false),
